...
const schema = new mongoose.Schema({
    ...
    settings: {
        ...
        bgl_min: {type: mongoose.Types.Decimal128, default: 4},
        bgl_max: {type: mongoose.Types.Decimal128, default: 8},
        steps: {type: Boolean, default: true, required: true},
        steps_min: {type: Number, default: 6000},
        steps_max: {type: Number, default: 5000},
